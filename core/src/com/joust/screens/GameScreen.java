...
public class GameScreen implements Screen {
    ...
    public void loadLevel(int levelNumber) {
        ...
        if (hero != null) {
            ...
            hero.reset(); // Ensure hero is properly initialized
        }
        ...
        // Log only essential level load information
        if (Gdx.app.getLogLevel() >= Gdx.app.LOG_DEBUG) {
            Gdx.app.debug("GameScreen", "Level " + levelNumber + " loaded: " + platforms.size() + " platforms, " + enemies.size() + " enemies");
        }
    }
    ...
    private void playerDied() {
        ...
        if (lives <= 0) {
            ...
            // Restart current level - force a complete reload to ensure correct positions
            gameObjects.clear();
            enemies.clear();
            platforms.clear();
            eggs.clear();
            hero = null; // Clear hero so level loader creates a new one
